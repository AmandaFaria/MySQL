...
insert into tb_categoria(material,oferta,ativo) values ("Argamassas",true,true);
insert into tb_categoria(material,oferta,ativo) values ("Drywall",false,true);
insert into tb_categoria(material,oferta,ativo) values ("Equipamentos Proteção",false,true);
insert into tb_categoria(material,oferta,ativo) values ("Madeiras",false,true);
insert into tb_categoria(material,oferta,ativo) values ("Cimento",true,true);
